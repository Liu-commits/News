...
<div class="easyui-panel" title="修改新闻" iconCls="icon-add" fit="true" style="width:750px " align="center" >
        ...
        <form id="edit-form" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                    <td>摘要:</td>
                    <td>
                        <textarea name="abstrs" rows="3" class="wu-textarea easyui-textbox easyui-validatebox" data-options="required:true,missingMessage:'请填写摘要！'" style="width:260px">${news.abstrs}</textarea>
                ...
                <tr>
                    <td>新闻封面:</td>
                    <td >
                        <input id="edit-photo" class="wu-text easyui-textbox easyui-validatebox" type="text" value="<c:url value="/resources/upload/news-pic.jpg"/>" name="photo" readonly="readonly" data-options="required:true,missingMessage:'请上传新闻封面！'"></input>
                ...
                <tr>
                    <td>新闻内容:</td>
                    <td>
                        <textarea id="edit-content" name="content" rows="6" style="width:700px;height: 300px">${news.content}</textarea>
                </tr>
            </table>
        </form>
...
<div id="preview-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-eye'" style="width:330px; padding:10px;">
        <table>
            <tr>
                <td>
                    <img id="preview-photo" src="${news.photo}" width="300px" style=" overflow:scroll;" onclick="preview()">
