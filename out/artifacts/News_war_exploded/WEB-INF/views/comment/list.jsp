	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td>内容:</td>
                <td>
                    <textarea name="content" rows="3" class="wu-textarea easyui-textbox easyui-validatebox" data-options="required:true,missingMessage:'请填写评论内容！'" style="width:260px"></textarea>
	...
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td>内容:</td>
                <td>
                    <textarea name="content"  id="edit-content" rows="3" class="wu-textarea easyui-textbox easyui-validatebox" data-options="required:true,missingMessage:'请填写评论内容！'" style="width:260px"></textarea>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'newsId',title:'新闻',width:100,formatter:function (value,row,index) {
